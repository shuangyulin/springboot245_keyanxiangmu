    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系电话" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="联系电话" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="联系电话" prop="yonghuPhone">
                           <el-input v-model="ruleForm.yonghuPhone"
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yonghuAddress'){
                          this.ruleForm.yonghuAddress = obj[o];
                          this.ro.yonghuAddress = true;
                          continue;
                      }
                      if(o=='yonghuDelete'){
