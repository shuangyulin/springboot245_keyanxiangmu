    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">科研项目验收管理系统注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="项目管理员姓名" class="input" v-if="tableName=='xiangmuguanliyuan'">
                            <el-input v-model="ruleForm.xiangmuguanliyuanName" autocomplete="off" placeholder="项目管理员姓名"  />
                        </el-form-item>
                        <el-form-item label="项目管理员身份证号" class="input" v-if="tableName=='xiangmuguanliyuan'">
                            <el-input v-model="ruleForm.xiangmuguanliyuanIdNumber" autocomplete="off" placeholder="项目管理员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='xiangmuguanliyuan'">
                            <el-input v-model="ruleForm.xiangmuguanliyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.xiangmuguanliyuanIdNumber)&& 'xiangmuguanliyuan'==this.tableName){
                                this.$message.error('项目管理员身份证号不能为空');
                                return
                            }
                            if('xiangmuguanliyuan' == this.tableName && this.ruleForm.xiangmuguanliyuanEmail&&(!this.$validate.isEmail(this.ruleForm.xiangmuguanliyuanEmail))){
